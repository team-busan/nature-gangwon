...
@Data
public class DeletePlanCommentResponseDto extends ResponseDto {
    public DeletePlanCommentResponseDto() {
        super();
    }

    public static ResponseEntity<DeletePlanCommentResponseDto> success() {
        DeletePlanCommentResponseDto responseBody = new DeletePlanCommentResponseDto();
