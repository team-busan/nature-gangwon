...
@Getter
public class PostPlanCommentLikeResponseDto extends ResponseDto {
    public PostPlanCommentLikeResponseDto() {
        super();
    }

    public static ResponseEntity<PostPlanCommentLikeResponseDto> success() {
        PostPlanCommentLikeResponseDto responseBody = new PostPlanCommentLikeResponseDto();
